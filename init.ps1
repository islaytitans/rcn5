...
Add-HostsEntry "cm.rcn5.localhost"
Add-HostsEntry "cd.rcn5.localhost"
Add-HostsEntry "id.rcn5.localhost"
Add-HostsEntry "www.rcn5.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.rcn5.localhost"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.rcn5.localhost"

    # RENDERING_HOST
    Set-DockerComposeEnvFileVariable "RENDERING_HOST" -Value "www.rcn5.localhost"
