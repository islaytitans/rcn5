...
dotnet sitecore login --cm https://cm.rcn5.localhost/ --auth https://id.rcn5.localhost/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.rcn5.localhost/sitecore/
Start-Process https://www.rcn5.localhost/
